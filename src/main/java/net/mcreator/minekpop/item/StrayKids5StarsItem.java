...
import net.mcreator.minekpop.procedures.StrayKids5StarsPlayerFinishesUsingItemProcedure;
...
public class StrayKids5StarsItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		StrayKids5StarsPlayerFinishesUsingItemProcedure.execute(world, x, y, z);
		return retval;
	}
}
