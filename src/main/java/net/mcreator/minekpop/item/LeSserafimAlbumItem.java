...
import net.mcreator.minekpop.procedures.LeSserafimAlbumPlayerFinishesUsingItemProcedure;
...
public class LeSserafimAlbumItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		LeSserafimAlbumPlayerFinishesUsingItemProcedure.execute(world, x, y, z);
		return retval;
	}
}
